...
(function() {
  if (window.location.pathname.match(/cards\/new/)) {
    $(function() {
      var addHiddenFieldForEntry, clearSelection, hiddenFieldId, removeHiddenFieldForEntry;
      $(document).on('click', '#yes-card', function() {
        $('#prompt').slideUp();
        return $('form#new_card').slideDown();
      });
      $('.btn.use-entry').on('click', function(evt) {
        var entryId;
        evt.preventDefault();
        ...
        if ($(this).hasClass('btn-success')) {
          return addHiddenFieldForEntry(entryId);
        } else {
          return removeHiddenFieldForEntry(entryId);
        }
      });
      ...
      hiddenFieldId = function(entryId) {
        return "char" + charNum + "entry" + entryId;
      };
      addHiddenFieldForEntry = function(entryId) {
        var input;
        input = $('<input>', {
        ...
        return $('form#new_card').append(input);
      };
